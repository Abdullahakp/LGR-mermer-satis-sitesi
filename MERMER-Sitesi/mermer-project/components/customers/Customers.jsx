...
const Customers = () => {
  ...
  return (
    <div className="container mx-auto mb-20 mt-12">
      <Title addClass="text-[40px] text-center">Heykeltraşlar Neler Yapmış</Title>
      <Slider {...settings}>
        <CustomerItem imgSrc="/Images/heyketras.jpeg" />
        <CustomerItem imgSrc="/Images/heykeltras1.jpeg" />
        <CustomerItem imgSrc="/Images/heyketras.jpeg" />
        <CustomerItem imgSrc="/Images/heykeltras1.jpeg" />
      </Slider>
    </div>
